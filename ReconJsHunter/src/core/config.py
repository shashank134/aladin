...
class Config:
    ...
    commoncrawl: CollectorConfig = field(default_factory=CollectorConfig)
    live_discovery: CollectorConfig = field(default_factory=CollectorConfig)
    google: CollectorConfig = field(default_factory=CollectorConfig)
    bing: CollectorConfig = field(default_factory=CollectorConfig)
    duckduckgo: CollectorConfig = field(default_factory=CollectorConfig)
    recursive_expansion: CollectorConfig = field(default_factory=CollectorConfig)
    ...
    def from_yaml(cls, path: str) -> 'Config':
        ...
        for collector in ['wayback', 'urlscan', 'alienvault', 'commoncrawl', 'live_discovery',
                          'google', 'bing', 'duckduckgo', 'recursive_expansion']:
